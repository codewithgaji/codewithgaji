...
**DevOps & Cloud:** Docker, Kubernetes, Terraform, Ansible, AWS  
**Tools:** Git, VS Code
...
| **PathWise AI** | AI-powered career guidance platform. React + FastAPI on Vercel + Railway. | [Demo](#) · [Repo](#) |
| **Blue World Verifier** | Cryptographic QR anti-counterfeit system deployed across separate frontend/backend subdomains. | [Demo](#) · [Repo](#) |
| **ReceiptFlow** | FastAPI e-commerce receipt generator platform. | [Demo](https://receipt-flow-eta.vercel.app/) · [Repo](https://github.com/codewithgaji/ReceiptFlow) |
| **RecipeVault** | FastAPI service providing clean access to food recipes. | [Demo](https://recipe-vault-pearl.vercel.app/) · [Repo](https://github.com/codewithgaji/Recipe-Vault) |
